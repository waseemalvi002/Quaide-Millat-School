...
const DEMO_TEACHERS = [
  { _id: '1', name: 'Ahmed Khan', email: 'ahmed.khan@qmschool.edu.pk', phone: '0300-1111111', qualification: 'M.Ed', designation: 'Senior Teacher', subjects: ['Urdu', 'Islamiat'], classes: ['Class 1', 'Class 2'], salary: 45000, status: 'active', joinDate: '2020-01-15' },
  { _id: '2', name: 'Muhammad Farooq', email: 'farooq@qmschool.edu.pk', phone: '0301-2222222', qualification: 'M.Sc Mathematics', designation: 'Head Teacher', subjects: ['Mathematics'], classes: ['Class 5', 'Class 6'], salary: 55000, status: 'active', joinDate: '2018-06-01' },
  { _id: '3', name: 'Sajid Ali', email: 'sajid@qmschool.edu.pk', phone: '0302-3333333', qualification: 'M.A English', designation: 'Teacher', subjects: ['English'], classes: ['Class 3', 'Class 4'], salary: 40000, status: 'active', joinDate: '2021-03-10' },
  { _id: '4', name: 'Kashif Iqbal', email: 'kashif@qmschool.edu.pk', phone: '0303-4444444', qualification: 'M.Sc Physics', designation: 'Teacher', subjects: ['Science', 'Physics'], classes: ['Class 7', 'Class 8'], salary: 42000, status: 'active', joinDate: '2019-09-01' },
  { _id: '5', name: 'Asif Mahmood', email: 'asif@qmschool.edu.pk', phone: '0304-5555555', qualification: 'M.A Urdu', designation: 'Teacher', subjects: ['Urdu'], classes: ['Class 9', 'Class 10'], salary: 38000, status: 'active', joinDate: '2022-01-15' },
  { _id: '6', name: 'Naveed Hassan', email: 'naveed@qmschool.edu.pk', phone: '0305-6666666', qualification: 'B.Ed', designation: 'Junior Teacher', subjects: ['Computer'], classes: ['Class 5', 'Class 6', 'Class 7'], salary: 35000, status: 'active', joinDate: '2023-02-01' },
  { _id: '7', name: 'Tahir Mehmood', email: 'tahir@qmschool.edu.pk', phone: '0306-7777777', qualification: 'M.Sc Chemistry', designation: 'Teacher', subjects: ['Chemistry', 'Biology'], classes: ['Class 9', 'Class 10'], salary: 43000, status: 'active', joinDate: '2020-07-15' },
  { _id: '8', name: 'Waqas Aslam', email: 'waqas@qmschool.edu.pk', phone: '0307-8888888', qualification: 'M.A History', designation: 'Teacher', subjects: ['Pakistan Studies', 'History'], classes: ['Class 8', 'Class 9'], salary: 40000, status: 'inactive', joinDate: '2019-04-01' },
  { _id: '9', name: 'Zahid Mehmood', email: 'zahid@qmschool.edu.pk', phone: '0308-9999999', qualification: 'B.Sc Computer Science', designation: 'IT Teacher', subjects: ['Computer'], classes: ['Class 8', 'Class 9', 'Class 10'], salary: 48000, status: 'active', joinDate: '2019-11-20' },
  { _id: '10', name: 'Usman Ali', email: 'usman@qmschool.edu.pk', phone: '0309-1010101', qualification: 'M.A Islamic Studies', designation: 'Teacher', subjects: ['Islamiat', 'Arabic'], classes: ['Class 6', 'Class 7', 'Class 8'], salary: 39000, status: 'active', joinDate: '2021-08-15' },
  { _id: '11', name: 'Kamran Shah', email: 'kamran@qmschool.edu.pk', phone: '0310-2020202', qualification: 'M.Sc Botany', designation: 'Science Teacher', subjects: ['Science', 'Biology'], classes: ['Class 9', 'Class 10'], salary: 44000, status: 'active', joinDate: '2018-03-12' },
  { _id: '12', name: 'Rehman Gul', email: 'rehman@qmschool.edu.pk', phone: '0311-3030303', qualification: 'B.A, B.Ed', designation: 'Primary Teacher', subjects: ['General Knowledge', 'Urdu'], classes: ['Class 1', 'Class 2', 'Class 3'], salary: 34000, status: 'inactive', joinDate: '2022-09-01' },
  { _id: '13', name: 'Bilal Javed', email: 'bilal@qmschool.edu.pk', phone: '0312-4040404', qualification: 'M.Sc Math', designation: 'Teacher', subjects: ['Mathematics'], classes: ['Class 7', 'Class 8'], salary: 41000, status: 'active', joinDate: '2021-11-05' },
  { _id: '14', name: 'Shoaib Malik', email: 'shoaib@qmschool.edu.pk', phone: '0313-5050505', qualification: 'M.A English', designation: 'Teacher', subjects: ['English'], classes: ['Class 9', 'Class 10'], salary: 42000, status: 'active', joinDate: '2020-02-14' },
  { _id: '15', name: 'Fahad Akram', email: 'fahad@qmschool.edu.pk', phone: '0314-6060606', qualification: 'M.Sc Physics', designation: 'Teacher', subjects: ['Physics', 'Science'], classes: ['Class 8', 'Class 9'], salary: 43000, status: 'active', joinDate: '2019-07-22' },
];
