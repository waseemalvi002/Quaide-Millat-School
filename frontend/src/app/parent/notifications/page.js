...
const DEMO = [
  { _id: '1', title: 'Fee Reminder', message: 'Monthly fee for February is due.', date: '2025-02-01', isRead: false },
  { _id: '2', title: 'PTM Notice', message: 'Parent-Teacher meeting on 25th Jan.', date: '2025-01-15', isRead: true },
];
    ...
    <DashboardLayout>
      <div style={{ padding: '24px' }}>
        ...
        <div style={{ background: 'rgba(59, 130, 246, 0.1)', borderLeft: '4px solid #3b82f6', padding: '16px', borderRadius: '12px', marginBottom: '24px', display: 'flex', gap: '12px', alignItems: 'flex-start', backdropFilter: 'blur(10px)' }}>
          ...
          <div>
            <h4 style={{ color: '#fff', margin: '0 0 4px', fontWeight: 800 }}>Parent Inbox</h4>
            <p style={{ color: '#94a3b8', margin: 0, fontSize: '0.85rem' }}>Receive important school alerts, fee reminders, and event invitations.</p>
          </div>
        </div>
