...
const DEMO = [
  { _id: '1', title: 'Fee Reminder', message: 'February fee is due. Please pay before 15th.', date: '2025-02-01', isRead: false },
  { _id: '2', title: 'Result Published', message: 'Monthly exam results for January published.', date: '2025-01-25', isRead: false },
  { _id: '3', title: 'Online Class', message: 'Mathematics class at 10:00 AM tomorrow.', date: '2025-01-19', isRead: true },
  { _id: '4', title: 'Holiday Notice', message: 'School closed on 5th Feb (Kashmir Day).', date: '2025-01-15', isRead: true },
];
  ...
  return (
    <DashboardLayout>
      <div style={{ padding: '24px' }}>
        ...
        <p style={{ color: '#94a3b8', marginBottom: '24px', fontWeight: 600 }}>{notifs.filter(n => !n.isRead).length} unread messages</p>
        ...
        <div style={{ background: 'rgba(59, 130, 246, 0.1)', borderLeft: '4px solid #3b82f6', padding: '16px', borderRadius: '12px', marginBottom: '24px', display: 'flex', gap: '12px', alignItems: 'flex-start', backdropFilter: 'blur(10px)' }}>
          ...
          <div>
            <h4 style={{ color: '#fff', margin: '0 0 4px', fontWeight: 800 }}>Student Inbox</h4>
            <p style={{ color: '#94a3b8', margin: 0, fontSize: '0.85rem' }}>Stay updated with school announcements, class schedules, and fee reminders.</p>
          </div>
        </div>
